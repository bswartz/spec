...
const (
	...
	// Indicates that the SP supports creating backups from
	// snapshots, creating volumes from backups, querying backup
	// information and deleting backups.
	ControllerServiceCapability_RPC_BACKUP ControllerServiceCapability_RPC_Type = 11
)
...
type VolumeContentSource_Backup struct {
	Backup *VolumeContentSource_BackupSource `protobuf:"bytes,3,opt,name=backup,proto3,oneof"`
}
...
func (*VolumeContentSource_Backup) isVolumeContentSource_Type() {}
...
func (m *VolumeContentSource) GetBackup() *VolumeContentSource_BackupSource {
	if x, ok := m.GetType().(*VolumeContentSource_Backup); ok {
		return x.Backup
	}
	return nil
}
...
func (*VolumeContentSource) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*VolumeContentSource_Backup)(nil),
	}
}
...
type VolumeContentSource_BackupSource struct {
	// Contains identity information for the existing source backup.
	// This field is REQUIRED. Plugins reporting BACKUP capability
	// MUST support creating a volume from a backup.
	BackupId string `protobuf:"bytes,1,opt,name=backup_id,json=backupId,proto3" json:"backup_id,omitempty"`
	// The format of the backup, for SPs that support more than one
	// format. This string should be prefixed by organization name
	// (i.e. "example.com/my-format") to avoid name collisions. This
	// field is REQUIRED.
	Format string `protobuf:"bytes,2,opt,name=format,proto3" json:"format,omitempty"`
	// Contains information identifying the S3 bucket containing the
	// backup. MUST be supplied by the CO. SPs SHOULD NOT return this
	// information.
	Location             *BackupLocation `protobuf:"bytes,3,opt,name=location,proto3" json:"location,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}

func (m *VolumeContentSource_BackupSource) Reset()         { *m = VolumeContentSource_BackupSource{} }
func (m *VolumeContentSource_BackupSource) String() string { return proto.CompactTextString(m) }
func (*VolumeContentSource_BackupSource) ProtoMessage()    {}
func (*VolumeContentSource_BackupSource) Descriptor() ([]byte, []int) {
	return fileDescriptor_9cdb00adce470e01, []int{8, 2}
}

func (m *VolumeContentSource_BackupSource) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_VolumeContentSource_BackupSource.Unmarshal(m, b)
}
func (m *VolumeContentSource_BackupSource) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_VolumeContentSource_BackupSource.Marshal(b, m, deterministic)
}
func (m *VolumeContentSource_BackupSource) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VolumeContentSource_BackupSource.Merge(m, src)
}
func (m *VolumeContentSource_BackupSource) XXX_Size() int {
	return xxx_messageInfo_VolumeContentSource_BackupSource.Size(m)
}
func (m *VolumeContentSource_BackupSource) XXX_DiscardUnknown() {
	xxx_messageInfo_VolumeContentSource_BackupSource.DiscardUnknown(m)
}

var xxx_messageInfo_VolumeContentSource_BackupSource proto.InternalMessageInfo

func (m *VolumeContentSource_BackupSource) GetBackupId() string {
	if m != nil {
		return m.BackupId
	}
	return ""
...
func (m *VolumeContentSource_BackupSource) GetFormat() string {
	if m != nil {
		return m.Format
	}
	return ""
...
func (m *VolumeContentSource_BackupSource) GetLocation() *BackupLocation {
	if m != nil {
		return m.Location
	}
	return nil
...
type BackupLocation struct {
	// The S3 endpoint of the object store. This field is REQUIRED.
	Endpoint string `protobuf:"bytes,1,opt,name=endpoint,proto3" json:"endpoint,omitempty"`
	// The S3 bucket name of the object store. This field is REQUIRED.
	Bucket string `protobuf:"bytes,2,opt,name=bucket,proto3" json:"bucket,omitempty"`
	// The S3 access key to use to access the object store. This
	// field is REQUIRED.
	AccessKey string `protobuf:"bytes,3,opt,name=accessKey,proto3" json:"accessKey,omitempty"`
	// The S3 secret for the given access key. This field is REQUIRED.
...
func (m *BackupLocation) Reset()         { *m = BackupLocation{} }
func (m *BackupLocation) String() string { return proto.CompactTextString(m) }
func (*BackupLocation) ProtoMessage()    {}
func (*BackupLocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_9cdb00adce470e01, []int{39}
}

func (m *BackupLocation) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_BackupLocation.Unmarshal(m, b)
}
func (m *BackupLocation) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_BackupLocation.Marshal(b, m, deterministic)
}
func (m *BackupLocation) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BackupLocation.Merge(m, src)
}
func (m *BackupLocation) XXX_Size() int {
	return xxx_messageInfo_BackupLocation.Size(m)
}
func (m *BackupLocation) XXX_DiscardUnknown() {
	xxx_messageInfo_BackupLocation.DiscardUnknown(m)
}

var xxx_messageInfo_BackupLocation proto.InternalMessageInfo

func (m *BackupLocation) GetEndpoint() string {
	if m != nil {
		return m.Endpoint
	}
	return ""
...
func (m *BackupLocation) GetBucket() string {
	if m != nil {
		return m.Bucket
	}
	return ""
...
func (m *BackupLocation) GetAccessKey() string {
	if m != nil {
		return m.AccessKey
	}
	return ""
...
func (m *BackupLocation) GetSecret() string {
	if m != nil {
		return m.Secret
	}
	return ""
...
type GetSupportedBackupFormatsRequest struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *GetSupportedBackupFormatsRequest) Reset()         { *m = GetSupportedBackupFormatsRequest{} }
func (m *GetSupportedBackupFormatsRequest) String() string { return proto.CompactTextString(m) }
func (*GetSupportedBackupFormatsRequest) ProtoMessage()    {}
func (*GetSupportedBackupFormatsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_9cdb00adce470e01, []int{40}
}

func (m *GetSupportedBackupFormatsRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetSupportedBackupFormatsRequest.Unmarshal(m, b)
}
func (m *GetSupportedBackupFormatsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetSupportedBackupFormatsRequest.Marshal(b, m, deterministic)
}
func (m *GetSupportedBackupFormatsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetSupportedBackupFormatsRequest.Merge(m, src)
}
func (m *GetSupportedBackupFormatsRequest) XXX_Size() int {
	return xxx_messageInfo_GetSupportedBackupFormatsRequest.Size(m)
}
func (m *GetSupportedBackupFormatsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GetSupportedBackupFormatsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GetSupportedBackupFormatsRequest proto.InternalMessageInfo

type GetSupportedBackupFormatsResponse struct {
	// List of supported backup formats. Each format should be prefixed
	// by organization name (i.e. "example.com/my-format") to avoid name
	// collisions. SPs that support the BACKUP controller capability
	// MUST return at least one format.
...
func (m *GetSupportedBackupFormatsResponse) Reset()         { *m = GetSupportedBackupFormatsResponse{} }
func (m *GetSupportedBackupFormatsResponse) String() string { return proto.CompactTextString(m) }
func (*GetSupportedBackupFormatsResponse) ProtoMessage()    {}
func (*GetSupportedBackupFormatsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_9cdb00adce470e01, []int{41}
}

func (m *GetSupportedBackupFormatsResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetSupportedBackupFormatsResponse.Unmarshal(m, b)
}
func (m *GetSupportedBackupFormatsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetSupportedBackupFormatsResponse.Marshal(b, m, deterministic)
}
func (m *GetSupportedBackupFormatsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetSupportedBackupFormatsResponse.Merge(m, src)
}
func (m *GetSupportedBackupFormatsResponse) XXX_Size() int {
	return xxx_messageInfo_GetSupportedBackupFormatsResponse.Size(m)
}
func (m *GetSupportedBackupFormatsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetSupportedBackupFormatsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GetSupportedBackupFormatsResponse proto.InternalMessageInfo

func (m *GetSupportedBackupFormatsResponse) GetFormats() []string {
	if m != nil {
		return m.Formats
	}
	return nil
...
type CreateBackupRequest struct {
	// The ID of the snapshot to back up. This field is REQUIRED.
	...
	// The suggested name for the backup. This field is REQUIRED for
	// idempotency.
	// Any Unicode string that conforms to the length limit is allowed
	// except those containing the following banned characters:
	// U+0000-U+0008, U+000B, U+000C, U+000E-U+001F, U+007F-U+009F.
	...
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	// The format of the backup, for SPs that support more than one
	// format. This string should be prefixed by organization name (i.e.
	// "example.com/my-format") to avoid name collisions. This field is
	// REQUIRED.
	Format string `protobuf:"bytes,3,opt,name=format,proto3" json:"format,omitempty"`
	// The location where the backup should be stored. This field is
	// REQUIRED.
	Location *BackupLocation `protobuf:"bytes,4,opt,name=location,proto3" json:"location,omitempty"`
	// Secrets required by plugin to complete backup creation request.
	// This field is OPTIONAL. Refer to the `Secrets Requirements`
	// section on how to use this field.
	Secrets map[string]string `protobuf:"bytes,5,rep,name=secrets,proto3" json:"secrets,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// Plugin specific parameters passed in as opaque key-value pairs.
...
func (m *CreateBackupRequest) GetSourceSnapshotId() string {
	if m != nil {
...
func (m *CreateBackupRequest) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *CreateBackupRequest) GetLocation() *BackupLocation {
	if m != nil {
		return m.Location
	}
	return nil
...
func (m *CreateBackupRequest) GetSecrets() map[string]string {
	if m != nil {
		return m.Secrets
	}
	return nil
...
func (m *CreateBackupRequest) GetParameters() map[string]string {
	if m != nil {
		return m.Parameters
	}
	return nil
...
type Backup struct {
	// This is the complete size of the backup in bytes. The purpose of
	// this field is to give CO guidance on how much space is needed to
	// create a volume from this backup. The size of the volume MUST NOT
	// be less than the size of the source backup. This field is
	// OPTIONAL. If this field is not set, it indicates that this size is
	// unknown. The value of this field MUST NOT be negative and a size of
	// zero means it is unspecified.
	SizeBytes int64 `protobuf:"varint,1,opt,name=size_bytes,json=sizeBytes,proto3" json:"size_bytes,omitempty"`
	// The identifier for this backup, generated by the plugin.
	// This field is REQUIRED.
	// This field MUST contain enough information to uniquely identify
	// this specific backup vs all other backup supported by this
	// plugin within a single S3 bucket.
	// This field SHALL be used by the CO in subsequent calls to refer to
	// this backup.
	// The SP is NOT responsible for global uniqueness of backup_id
	// across multiple SPs or multiple S3 buckets.
	BackupId string `protobuf:"bytes,2,opt,name=backup_id,json=backupId,proto3" json:"backup_id,omitempty"`
	// Identity information for the source snapshot. Note that creating a
	// backup from a volume is not supported here so the source has to
	// be a snapshot. This field is REQUIRED.
	...
	// Indicates if a backup is ready to use as a
	// `volume_content_source` in a `CreateVolumeRequest`. The default
	// value is false. This field is REQUIRED.
...
func (m *Backup) GetSourceSnapshotId() string {
	if m != nil {
		return m.SourceSnapshotId
	}
	return ""
...
func (m *Backup) GetReadyToUse() bool {
	if m != nil {
		return m.ReadyToUse
	}
	return false
...
type CreateBackupResponse struct {
	// Contains all attributes of the newly created backup that are
	// relevant to the CO along with information required by the Plugin
	// to uniquely identify the snapshot. This field is REQUIRED.
...
func (m *CreateBackupResponse) GetBackup() *Backup {
	if m != nil {
		return m.Backup
	}
	return nil
...
type DeleteBackupRequest struct {
	// The ID of the backup to delete. This field is REQUIRED.
	BackupId string `protobuf:"bytes,1,opt,name=backup_id,json=backupId,proto3" json:"backup_id,omitempty"`
	// The format of the backup, for SPs that support more than one
	// format. This string should be prefixed by organization name (i.e.
	// "example.com/my-format") to avoid name collisions. This field is
	// REQUIRED.
	Format string `protobuf:"bytes,2,opt,name=format,proto3" json:"format,omitempty"`
	// The location where the backup should be deleted from. This field is
	// REQUIRED.
	Location *BackupLocation `protobuf:"bytes,3,opt,name=location,proto3" json:"location,omitempty"`
	// Secrets required by plugin to complete backup deletion request.
	// This field is OPTIONAL. Refer to the `Secrets Requirements`
	// section on how to use this field.
...
func (m *DeleteBackupRequest) GetBackupId() string {
	if m != nil {
		return m.BackupId
	}
	return ""
...
func (m *DeleteBackupRequest) GetFormat() string {
	if m != nil {
		return m.Format
	}
	return ""
...
func (m *DeleteBackupRequest) GetLocation() *BackupLocation {
	if m != nil {
		return m.Location
	}
	return nil
...
func (m *DeleteBackupRequest) GetSecrets() map[string]string {
	if m != nil {
		return m.Secrets
	}
	return nil
...
type GetBackupRequest struct {
	// The ID of a specific backup. This field is REQUIRED.
	BackupId string `protobuf:"bytes,1,opt,name=backup_id,json=backupId,proto3" json:"backup_id,omitempty"`
	// The format of the backup, for SPs that support more than one
	// format. This string should be prefixed by organization name (i.e.
	// "example.com/my-format") to avoid name collisions. This field is
	// REQUIRED.
	Format string `protobuf:"bytes,2,opt,name=format,proto3" json:"format,omitempty"`
	// The location where the backup exists. This field is
	// REQUIRED.
	Location *BackupLocation `protobuf:"bytes,3,opt,name=location,proto3" json:"location,omitempty"`
	// Secrets required by plugin to complete GetBackup request.
	// This field is OPTIONAL. Refer to the `Secrets Requirements`
	// section on how to use this field.
	Secrets              map[string]string `protobuf:"bytes,4,rep,name=secrets,proto3" json:"secrets,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
...
func (m *GetBackupRequest) GetFormat() string {
	if m != nil {
		return m.Format
	}
	return ""
...
func (m *GetBackupRequest) GetLocation() *BackupLocation {
	if m != nil {
		return m.Location
	}
	return nil
...
func (m *GetBackupRequest) GetSecrets() map[string]string {
	if m != nil {
		return m.Secrets
	}
	return nil
...
func (m *GetBackupResponse) GetBackup() *Backup {
	if m != nil {
		return m.Backup
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*VolumeContentSource_BackupSource)(nil), "csi.v1.VolumeContentSource.BackupSource")
	...
	proto.RegisterType((*BackupLocation)(nil), "csi.v1.BackupLocation")
	proto.RegisterType((*GetSupportedBackupFormatsRequest)(nil), "csi.v1.GetSupportedBackupFormatsRequest")
	proto.RegisterType((*GetSupportedBackupFormatsResponse)(nil), "csi.v1.GetSupportedBackupFormatsResponse")
	proto.RegisterType((*CreateBackupRequest)(nil), "csi.v1.CreateBackupRequest")
	proto.RegisterMapType((map[string]string)(nil), "csi.v1.CreateBackupRequest.ParametersEntry")
	proto.RegisterMapType((map[string]string)(nil), "csi.v1.CreateBackupRequest.SecretsEntry")
	proto.RegisterType((*Backup)(nil), "csi.v1.Backup")
	proto.RegisterType((*CreateBackupResponse)(nil), "csi.v1.CreateBackupResponse")
	proto.RegisterType((*DeleteBackupRequest)(nil), "csi.v1.DeleteBackupRequest")
	proto.RegisterMapType((map[string]string)(nil), "csi.v1.DeleteBackupRequest.SecretsEntry")
	proto.RegisterType((*DeleteBackupResponse)(nil), "csi.v1.DeleteBackupResponse")
	proto.RegisterType((*GetBackupRequest)(nil), "csi.v1.GetBackupRequest")
	proto.RegisterMapType((map[string]string)(nil), "csi.v1.GetBackupRequest.SecretsEntry")
	proto.RegisterType((*GetBackupResponse)(nil), "csi.v1.GetBackupResponse")
...
var fileDescriptor_9cdb00adce470e01 = []byte{
	...
	,
}
...
type ControllerClient interface {
	...
	GetSupportedBackupFormats(ctx context.Context, in *GetSupportedBackupFormatsRequest, opts ...grpc.CallOption) (*GetSupportedBackupFormatsResponse, error)
...
func (c *controllerClient) GetSupportedBackupFormats(ctx context.Context, in *GetSupportedBackupFormatsRequest, opts ...grpc.CallOption) (*GetSupportedBackupFormatsResponse, error) {
	out := new(GetSupportedBackupFormatsResponse)
	err := c.cc.Invoke(ctx, "/csi.v1.Controller/GetSupportedBackupFormats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *controllerClient) CreateBackup(ctx context.Context, in *CreateBackupRequest, opts ...grpc.CallOption) (*CreateBackupResponse, error) {
	out := new(CreateBackupResponse)
	err := c.cc.Invoke(ctx, "/csi.v1.Controller/CreateBackup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *controllerClient) DeleteBackup(ctx context.Context, in *DeleteBackupRequest, opts ...grpc.CallOption) (*DeleteBackupResponse, error) {
	out := new(DeleteBackupResponse)
	err := c.cc.Invoke(ctx, "/csi.v1.Controller/DeleteBackup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *controllerClient) GetBackup(ctx context.Context, in *GetBackupRequest, opts ...grpc.CallOption) (*GetBackupResponse, error) {
	out := new(GetBackupResponse)
	err := c.cc.Invoke(ctx, "/csi.v1.Controller/GetBackup", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ControllerServer interface {
	...
	GetSupportedBackupFormats(context.Context, *GetSupportedBackupFormatsRequest) (*GetSupportedBackupFormatsResponse, error)
...
func (*UnimplementedControllerServer) GetSupportedBackupFormats(ctx context.Context, req *GetSupportedBackupFormatsRequest) (*GetSupportedBackupFormatsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSupportedBackupFormats not implemented")
}
func (*UnimplementedControllerServer) CreateBackup(ctx context.Context, req *CreateBackupRequest) (*CreateBackupResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateBackup not implemented")
}
func (*UnimplementedControllerServer) DeleteBackup(ctx context.Context, req *DeleteBackupRequest) (*DeleteBackupResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteBackup not implemented")
}
func (*UnimplementedControllerServer) GetBackup(ctx context.Context, req *GetBackupRequest) (*GetBackupResponse, error) {
...
func _Controller_GetSupportedBackupFormats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSupportedBackupFormatsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ControllerServer).GetSupportedBackupFormats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/csi.v1.Controller/GetSupportedBackupFormats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ControllerServer).GetSupportedBackupFormats(ctx, req.(*GetSupportedBackupFormatsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Controller_CreateBackup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateBackupRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ControllerServer).CreateBackup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/csi.v1.Controller/CreateBackup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ControllerServer).CreateBackup(ctx, req.(*CreateBackupRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Controller_DeleteBackup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteBackupRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ControllerServer).DeleteBackup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/csi.v1.Controller/DeleteBackup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ControllerServer).DeleteBackup(ctx, req.(*DeleteBackupRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Controller_GetBackup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBackupRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ControllerServer).GetBackup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/csi.v1.Controller/GetBackup",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ControllerServer).GetBackup(ctx, req.(*GetBackupRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Controller_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetSupportedBackupFormats",
			Handler:    _Controller_GetSupportedBackupFormats_Handler,
		},
		{
			MethodName: "CreateBackup",
			Handler:    _Controller_CreateBackup_Handler,
		},
		{
			MethodName: "DeleteBackup",
			Handler:    _Controller_DeleteBackup_Handler,
		},
		{
			MethodName: "GetBackup",
			Handler:    _Controller_GetBackup_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "github.com/container-storage-interface/spec/csi.proto",
